  ...
  return (
    <div className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto min-h-screen bg-[#EDEEE9] text-[#15181A]">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 mb-8 pb-6 border-b border-[#CFD1CA]">
        <div>
          <span className="text-xs uppercase tracking-[0.2em] font-semibold text-[#A2432B] mb-1 block">
          ...
          <div className="flex items-center gap-2 text-sm text-[#5B605F] mt-2">
            <MapPin className="w-4 h-4 text-[#A2432B]" />
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`p-3 rounded-none border transition-colors ${
                isSaved ? 'bg-[#A2432B] text-white border-[#A2432B]' : 'bg-[#F7F7F4] text-[#15181A] border-[#CFD1CA]'
              }`}
            ...
            <button
              ...
              className={`p-3 rounded-none border transition-colors ${
                isInCompare ? 'bg-[#A2432B] text-white border-[#A2432B]' : 'bg-[#F7F7F4] text-[#15181A] border-[#CFD1CA]'
              }`}
      ...
      <ScrollReveal animation="fade-up">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 bg-[#F7F7F4] border border-[#CFD1CA] mb-12 shadow-xs">
          <div>
            ...
            <div className="flex items-center gap-2">
              <BedDouble className="w-4 h-4 text-[#A2432B]" />
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Maximize2 className="w-4 h-4 text-[#A2432B]" />
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Calendar className="w-4 h-4 text-[#A2432B]" />
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <Layers className="w-4 h-4 text-[#A2432B]" />
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {(property.highlights || []).map((item, idx) => (
                    <li key={idx} className="flex items-start gap-2.5 text-xs sm:text-sm text-[#15181A]">
                      <CheckCircle2 className="w-4 h-4 text-[#A2432B] shrink-0 mt-0.5" />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {(property.amenities || []).map((amenity, idx) => (
                  <div key={idx} className="flex items-center gap-2 text-xs sm:text-sm text-[#15181A]">
                    <Sparkles className="w-3.5 h-3.5 text-[#A2432B]" />
                    <span>{amenity}</span>
                  </div>
                ))}
              </div>
        ...
        <aside className="lg:col-span-4">
          <div className="sticky top-28 bg-[#F7F7F4] border border-[#CFD1CA] p-6 space-y-6 shadow-xs">
              ...
              <form onSubmit={handleEnquirySubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-white border border-[#CFD1CA] text-xs focus:outline-none focus:border-[#A2432B]"
                ...
                <button
                  type="submit"
                  className="w-full py-3 bg-[#A2432B] hover:bg-[#8C3822] text-white text-xs uppercase tracking-widest font-semibold transition-colors flex items-center justify-center gap-2 cursor-pointer"
                >
            ...
            <div className="pt-4 border-t border-[#CFD1CA] space-y-2 text-xs text-[#5B605F]">
              <div className="flex items-center gap-2">
                <Phone className="w-3.5 h-3.5 text-[#A2432B]" />
                <a href="tel:+912249887700" className="hover:text-[#15181A]">
                  +91 (022) 4988 7700
                </a>
              </div>
              <div className="flex items-center gap-2 text-[11px]">
                <ShieldCheck className="w-3.5 h-3.5 text-[#A2432B]" />
      ...
      {lightboxOpen && (
        ...
        >
          <button
            ...
            className="absolute top-6 right-6 text-white hover:text-[#A2432B] p-2 cursor-pointer"
          >
            <X className="w-8 h-8" />
          </button>
